...
**版本**：v4.28-draft
**日期**：2026-08-26
**状态**：P0/P1/P2/P3 完成；P4.1~P4.7 完成；P5 完成（P5.1~P5.7）；P6.1~P6.8 完成；P7 完成（P7.1~P7.6）；P8 完成（P8.1~P8.6）；P9 进行中（P9.1 完成）；Web 体验与可靠性迭代完成；pytest 插件重写完成；任务定义配置 UI 由插件提供；插件版本切换自动停用旧版本；任务队列改为真实 Run 队列；离线节点不创建派发记录并明确进入等待队列；节点上线自动补偿派发 pending Shard；通知投递内容可追溯；任务级通知订阅与运行进度推送完成；RBAC 角色边界完成第一版
