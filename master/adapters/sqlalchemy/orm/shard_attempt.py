...
class ShardAttempt(Base, TimestampMixin):
    ...
    # sym:last_progress_sequence V2 进度去重序号
    ...
    last_log_sequence: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    # sym:log_entry_count V2 Attempt 日志条数
    log_entry_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
