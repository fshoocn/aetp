...
**版本**：v3.3-draft
**日期**：2026-08-14
**状态**：P0/P1/P2/P3 完成；P4.1~P4.7 完成；P5 进行中（P5.1）
...
# 内部签名下载端点（P4.7：Agent 经签名 URL 下载脚本包并校验 sha256）
...
| P5 Agent MVP | P4 | Agent 配置/账本/注册/ACK、插件 registry、脚本缓存、parse worker | 🟡 进行中（P5.1） |
...
| D Agent 最小骨架 | 配置/账本/注册/ACK、插件 registry、脚本缓存、parse worker | P5 | 🟡（P5.1 完成） |
