...
> ✅ 已实现（P3.2）：`test_scripts` / `script_cases` 表与仓储已落地（唯一约束、sha256 幂等、avg_duration_s/duration_samples、软删除）；上传/解析 API 与任务定义引用属后续阶段（P3.3/P7.3）。
