...
| P3 领域、事件与持久化 | P2 | 脚本/用例/定义/Run/Shard/Attempt 表、状态机、Inbox/Outbox、ports、插件数据接口 | 🟡 进行中（P3.1/P3.2 完成） |
